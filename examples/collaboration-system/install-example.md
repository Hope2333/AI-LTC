...
3. rewrite `00_HANDOFF.md` and the placeholder lane files under `.ai/active-lane/`
4. clear `ESCALATION_REQUEST.md` unless you are copying an active escalation intentionally
5. update `docs/ai-relay.md`, `docs/ai-collaboration.md`, and `docs/ai-workbench.md` for the real project
...
- `00_HANDOFF.md` reflects the real bootstrap state
- `ESCALATION_REQUEST.md` is either empty, removed, or rewritten for the real project
...
6. run the first bounded execution pass
