...
- repeated deadlock or architecture-level uncertainty that should trigger `@ARCHITECT_HELP`
...
- ignore an existing `00_HANDOFF.md` or `ESCALATION_REQUEST.md`
